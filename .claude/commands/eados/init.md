---
description: EADOS init phase — frame the project, load the domain profile, write the manifest skeleton (role: enterprise-architect)
---

Run the governed EADOS command **`/eados init`**.
...
- **Procedure:** `.eados-core/orchestrator/commands/init.md`
